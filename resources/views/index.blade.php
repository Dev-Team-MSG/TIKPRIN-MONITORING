                        ...
                        <div class="statistic-details mt-sm-4">
                            <div class="statistic-details-item">
                                <span class="text-muted"><span class="text-primary">
                                        @if ($countTicketWeekAgo > $countTicketThisWeek)
                                            <i class="fas fa-caret-down"></i>
                                        @elseif($countTicketWeekAgo < $countTicketThisWeek)
                                            <i class="fas fa-caret-down"></i>
                                        @else
                                            <i></i>
                                        @endif
                                    </span>
                                    7% {{ $countTicketWeekAgo }}</span>
                                <div class="detail-value">{{ $countTicketToday }}</div>
                                <div class="detail-name">Today's Ticket</div>
                            </div>
                            <div class="statistic-details-item">
                                <span class="text-muted"><span class="text-danger"><i class="fas fa-caret-up"></i></span>
                                    23%</span>
                                <div class="detail-value">{{ $countTicketThisWeek }}</div>
                                <div class="detail-name">This Week</div>
                            </div>
                            <div class="statistic-details-item">
                                <span class="text-muted"><span class="text-primary"><i
                                            class="fas fa-caret-up"></i></span>9%</span>
                                <div class="detail-value">{{ $countTicketThisMonth }}</div>
                                <div class="detail-name">This Month</div>
                            </div>
                            <div class="statistic-details-item">
                                <span class="text-muted"><span class="text-primary"><i class="fas fa-caret-up"></i></span>
                                    19%</span>
                                <div class="detail-value">{{ $countTicketThisYear }}</div>
        ...
        <script>
            ...
            var myChart = new Chart(statistics_chart, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Statistics',
                        data: [{{ $getTicketThisWeek['Sunday'] }}, {{ $getTicketThisWeek['Monday'] }},
                            {{ $getTicketThisWeek['Tuesday'] }}, {{ $getTicketThisWeek['Wednesday'] }},
                            {{ $getTicketThisWeek['Thursday'] }}, {{ $getTicketThisWeek['Friday'] }},
                            {{ $getTicketThisWeek['Saturday'] }}
                        ],
                        borderWidth: 5,
                        borderColor: '#6777ef',
